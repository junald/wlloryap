...
public class BranchSetting extends javax.swing.JPanel {
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        if (evt.getClickCount() > 1) {
            ...
            if (jTable.getRowCount() > 0) {
                ...
                Branch b = (Branch) jTable.getValueAt(row, 1);
                if (b != null) {
                    try {
                        branch = bDao.find(b.getId());
                        initScreen();
                    } catch (Exception ex) {
                        Logger.getLogger(BranchSetting.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        }
    ...
    private void initScreen() {
        disableAllControls(true);
        txtId.setText(branch.getId()==null? "": branch.getId()+"");
        txtCode.setText(branch.getCode());
    ...
    private void saveScreen() {
        ...
        branch.setDescription(txtDescription.getText());
